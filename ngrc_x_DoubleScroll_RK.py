"""
Reconstruction of x-coordinate of the Double Scroll system.
Numerical scheme is the Runge-Kutta 4 (5) method. 

Created on Tue Jul 22 07:19:25 2025
...
if method == 'Euler':
    filename = 'DoubleScroll_ts_Euler_{}_{}_{}.txt'.format(ttrain+ttest+warmup*dt_fine, 0.01, seed)
if method == 'RK45':
    filename = 'DoubleScroll_ts_RK45_{}_{}_{}.txt'.format(ttrain+ttest+warmup*dt_fine, dt_fine, seed)
...
# Recording only the x-component of the Lorenz system
index = np.array([0])
