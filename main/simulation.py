...
from .dyn_sys.Double_Scroll import parametric_DoubleScroll
...
#%%
    def ngrc_rk_method(self, params):
        '''
        ...
        ts_filename = folder+'Lorenz_ts_RK_{}_{}_{}.txt'.format(ttrain+ttest+warmup*dt, 
                                                                dt_fine, 
                                                                seed)
        ...
        return exp_dict
#%%
    def ngrc_rk_method_index(self, params):
        '''
        To train and test performance of a NGRC for the given parameters.
        It creates dynamic time series generation using Runge-Kutta 4 (5) method.
        ...
        return exp_dict
#%%
    def ngrc_rk_method_DoubleScroll(self, params):
        '''
        To train and test performance of a NGRC for the given parameters.
        It creates dynamic time series generation using Runge-Kutta 4 (5) method.
        It is specific for the DoubleScroll dynamics
