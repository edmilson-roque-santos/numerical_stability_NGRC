...
if method == 'Euler':
    filename = 'Lorenz_ts_Euler_{}_{}_{}.txt'.format(ttrain+ttest+warmup*dt_fine, 0.01, seed)
if method == 'RK45':
    filename = 'Lorenz_ts_RK45_{}_{}_{}.txt'.format(ttrain+ttest+warmup*dt_fine, dt_fine, seed)
